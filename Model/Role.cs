...
namespace Es.Udc.DotNet.PracticaMaD.Model
{
    ...
    public partial class Role
    {
    	...
    	public static bool operator ==(Role  objA, Role  objB)
        {
            // Check if the objets are the same Role entity
    	...
    	public override String ToString()
    	{
    		...
    		strRole.Append("[ ");
           strRole.Append(" roleId = " + roleId + " | " );       
           strRole.Append(" name = " + name + " | " );       
            strRole.Append("] ");    
